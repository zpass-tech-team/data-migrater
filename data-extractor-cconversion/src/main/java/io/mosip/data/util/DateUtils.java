...
import io.mosip.data.constant.DateUtilConstants;
import io.mosip.data.exception.IllegalArgumentException;
import io.mosip.data.exception.NullPointerException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.data.exception.ParseException(
