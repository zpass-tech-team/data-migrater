...
import io.mosip.packet.extractor.constant.DateUtilConstants;
import io.mosip.packet.extractor.exception.IllegalArgumentException;
import io.mosip.packet.extractor.exception.NullPointerException;
...
public final class DateUtils {
	...
	public static LocalDateTime parseUTCToLocalDateTime(String utcDateTime, String pattern) {
		...
		try {
			...
			throw new io.mosip.packet.extractor.exception.ParseException(
