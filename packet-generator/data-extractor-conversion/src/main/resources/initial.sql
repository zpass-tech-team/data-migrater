...
CREATE TABLE "MOSIP"."PACKET_TRACKER" ("SESSION_KEY" VARCHAR(100) NOT NULL, "REF_ID" VARCHAR(100) NOT NULL, "REG_NO" VARCHAR(100), "ACTIVITY" VARCHAR(50), "STATUS" VARCHAR(50), "PROCESS" VARCHAR(50) NOT NULL, "REQUEST" CLOB, "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP);
...
CREATE INDEX IX_PACKET_TRACKER ON "MOSIP"."PACKET_TRACKER" ("REF_ID", "ACTIVITY", "SESSION_KEY");
