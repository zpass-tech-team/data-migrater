...
CREATE TABLE "MOSIP"."PACKET_TRACKER" ("REF_ID" VARCHAR(100) NOT NULL, "REG_NO" VARCHAR(100) NOT NULL, "STATUS" VARCHAR(50), "PROCESS" VARCHAR(50) NOT NULL, "REQUEST" VARCHAR(3000), "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP);
...
ALTER TABLE "MOSIP"."PACKET_TRACKER" ADD CONSTRAINT "PK_REF_ID" PRIMARY KEY ("REF_ID");
