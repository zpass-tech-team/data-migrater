...
CREATE TABLE "MOSIP"."PACKET_TRACKER" ("REF_ID" VARCHAR(100) NOT NULL, "REG_NO" VARCHAR(100), "STATUS" VARCHAR(50), "PROCESS" VARCHAR(50) NOT NULL, "REQUEST" VARCHAR(3000), "CR_BY" VARCHAR(256) NOT NULL, "CR_DTIMES" TIMESTAMP NOT NULL, "UPD_BY" VARCHAR(256), "UPD_DTIMES" TIMESTAMP);
